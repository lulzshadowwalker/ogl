...
int main( void )
{
    ...
    GLFWwindow* window = glfwCreateWindow(1024, 768, "hello, lulzie.", NULL, NULL);
    if ( window == NULL )
    {
    ...
    // Generate, bind, and fill the buffer
    GLuint vertexBuffer;
    ...
    GLuint programID = LoadShaders( "/Users/lulz/dev/ogl/tutorial04_colored_cube/TransformVertexShader.vertexshader", "/Users/lulz/dev/ogl/tutorial04_colored_cube/ColorFragmentShader.fragmentshader" );
